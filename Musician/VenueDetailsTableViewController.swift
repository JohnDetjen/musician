        ...
        case 0:
            if let email = venue.object(forKey: "contactEmail") as? String {
                if MFMailComposeViewController.canSendMail() {
                    ...
                    mail.setMessageBody("I manage \(bandName). </br>\(website).</br></br>We have a 15 date tour starting from \(hometown).</br></br>We would like to place a hold if you have availability this upcoming month.</br></br>Thank you. </br>Thanks.</br></br>\(bandName)", isHTML: true)
